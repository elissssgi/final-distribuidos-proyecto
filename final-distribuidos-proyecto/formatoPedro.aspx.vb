...
Public Class formato
    ...
    Dim formatoNegocio As New clsFormatoPedro()
    ...
    Private Sub CargarDatos()
        gvFormatos.DataSource = formatoNegocio.obtenerTodos()
        gvFormatos.DataBind()
    End Sub
    ...
    Protected Sub btnGuardar_Click(sender As Object, e As EventArgs)
        ...
        If lblTitulo.Text = "Agregar Formato" Then
            formatoNegocio.registrar(nombre_formato, vigencia)
        Else
            Dim id_formato As Integer = ViewState("id_formato")
            formatoNegocio.modificar(id_formato, nombre_formato, vigencia)
        End If
    ...
    Protected Sub gvFormatos_RowUpdating(sender As Object, e As GridViewUpdateEventArgs)
        ...
        formatoNegocio.modificar(id_formato, txtNombreFormato.Text, chkEditVigencia.Checked)
    ...
    Protected Sub gvFormatos_RowCommand(sender As Object, e As GridViewCommandEventArgs)
        If e.CommandName = "Eliminar" Then
            ...
            formatoNegocio.eliminar(id_formato)
            CargarDatos()
        End If
    End Sub
